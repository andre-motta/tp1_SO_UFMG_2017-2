...
main(int argc, char *argv[])
{
  ...
  28:	ff 35 f0 09 00 00    	pushl  0x9f0
  2e:	e8 cd 03 00 00       	call   400 <printf>
        exit();
  33:	e8 7a 02 00 00       	call   2b2 <exit>
    }
  ...
  4a:	68 3c 07 00 00       	push   $0x73c
  4f:	ff 35 f4 09 00 00    	pushl  0x9f4
...
free(void *ap)
{
 ...
 5a1:	a1 f8 09 00 00       	mov    0x9f8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 f8 09 00 00       	mov    %eax,0x9f8
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 f8 09 00 00       	mov    %eax,0x9f8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 f8 09 00 00    	mov    0x9f8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6f4:	eb e9                	jmp    6df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 f8 09 00 00 fc 	movl   $0x9fc,0x9f8
 6fd:	09 00 00 
 700:	c7 05 fc 09 00 00 fc 	movl   $0x9fc,0x9fc
 707:	09 00 00 
    base.s.size = 0;
 70a:	b8 fc 09 00 00       	mov    $0x9fc,%eax
 70f:	c7 05 00 0a 00 00 00 	movl   $0x0,0xa00
 716:	00 00 00 
