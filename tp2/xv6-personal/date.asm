...
main(int argc, char *argv[])
{
  ...
  21:	50                   	push   %eax
  22:	50                   	push   %eax
  23:	68 40 07 00 00       	push   $0x740
  28:	ff 35 10 0a 00 00    	pushl  0xa10
  ...
  4a:	68 5c 07 00 00       	push   $0x75c
  4f:	ff 35 14 0a 00 00    	pushl  0xa14
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 6f 07 00 00       	mov    $0x76f,%eax
