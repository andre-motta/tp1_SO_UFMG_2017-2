...
main(int argc, char *argv[])
{
  ...
  28:	ff 35 00 0a 00 00    	pushl  0xa00
  ...
  4a:	68 4c 07 00 00       	push   $0x74c
  4f:	ff 35 04 0a 00 00    	pushl  0xa04
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 68 07 00 00 	movzbl 0x768(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 5f 07 00 00       	mov    $0x75f,%eax
